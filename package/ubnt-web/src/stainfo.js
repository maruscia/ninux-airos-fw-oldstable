...
function setAck(ack, distance) {
	...
	var dist_km = (dist / 1000.00).toFixed(1);
	var dist_mi = (dist / 1609.344).toFixed(1);
...
function formatBytes(bytes) {
	...
	if (bytes > 1024*1024*1024)
		bytesStr += ' (' + (bytes / (1024*1024*1024)).toFixed(2) + ' GBytes)';
	else if (bytes > 1024*1024)
		bytesStr += ' (' + (bytes / (1024*1024)).toFixed(2) + ' MBytes)';
	else if (bytes > 1024)
		bytesStr += ' (' + (bytes / 1024).toFixed(2) + ' kBytes)';
